...
export default function Hero() {
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      {/* Dark overlay */}
      <div className="absolute inset-0 z-10 bg-gradient-to-b from-black/30 via-transparent to-[#080808]" />
      ...
      <div className="relative z-20 text-center px-6 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            href="#contact"
            className="px-8 py-4 border border-white/30 text-white font-bold text-sm tracking-widest uppercase hover:border-white/80 transition-colors duration-200"
          >
            Let's Work Together
          </a>
        </div>
