    ...
    <section id="contact" className="py-32 px-6 border-t border-white/10">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <h2 className="text-5xl md:text-7xl font-black tracking-tight leading-none mb-6">
          Ready to
          <br />
          <span className="text-[#e8c547]">shoot?</span>
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="px-10 py-5 bg-[#e8c547] text-black font-black text-sm tracking-widest uppercase hover:bg-white transition-colors duration-200"
          >
            WhatsApp Us
          </a>
          <a
